            ...
            <table class="table align-middle">
                ...
                <tbody>
                    <tr>
                        <td>1.</td>
                        <td>Pizza</td>
                        <td><img width="100px" src="./img/pizza.jpg" alt=""></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td>
                    ...
                    <tr>
                        <td>2.</td>
                        <td>Burger</td>
                        <td><img src="./img/bugu.jpg" width="100px" alt=""></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td>
                            <a href="" class="btn-success">Update Category</a>
                    ...
                    <tr>
                        <td>3.</td>
                        <td>MoMo</td>
                        <td><img src="./img/banhbao.jpg" width="100px" alt=""></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td>
                            <a href="" class="btn-success">Update Category</a>
                    ...
                    <tr>
                        ...
                        <td><img src="./img/categories.jpg" width="100px" alt=""></td>
                        <td>Yes</td>
                        <td>Yes</td>
                        <td>
                            <a href="" class="btn-success">Update Category</a>
