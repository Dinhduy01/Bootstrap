    ...
    <main>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col img-food">
                    <img src="./img/bugu.jpg" alt="">
                    <h3 class="name-of-food">buger</h3>
                </div>
                <div class="col img-food">
                    <img src="./img/banhbao.jpg" alt="">
        ...
        <div class="container overflow-hidden">
            ...
            <div class="row gy-5">
                <div class="col-6">
                    <div class="p-3 border bg-light"><img class="img-food1" src="./img/piza1.jpg" alt="">
                ...
                <div class="col-6">
                    <div class="p-3 border bg-light"><img class="img-food1" src="./img/burger1.jpg" alt="">
                        <div class="content-food1">
                            <h4>Dumplings Specials</h4>
                            <p>$5.00</p>
                            <p>Chicken Dumpling with herbs from Mountains</p>
                ...
                <div class="col-6">
                    <div class="p-3 border bg-light"><img class="img-food1" src="./img/momo1.jpg" alt="">
                        <div class="content-food1">
                            <h4>Dumplings Specials</h4>
                            <p>$5.00</p>
                            <p>Chicken Dumpling with herbs from Mountains</p>
